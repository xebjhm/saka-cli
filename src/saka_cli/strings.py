...
STRINGS = {
    'en': {
        ...
        "mode_selection": "\nSelect Mode:\n[1] Message Backup (Subscription Required)\n[2] Official Blog Backup (Free)\n> ",
        ...
        "blog_found_posts": "Found {} blog posts to download.",
        "blog_no_blogs": "No blogs found to download.",
        "blog_tqdm_scanning": "Scanning",
        ...
        "run_done": "\nDone!",
        "run_tqdm_scanning": "Scanning Groups",
        "run_tqdm_fetching": "Fetching Members",
        ...
        "msg_fetching_members": "Fetching member list...",
        "msg_select_members": "\nSubscribed Members:",
        "msg_offline_members": "\nPast Subscriptions/Unsubscribed Members:",
        "msg_id_prompt": "\nEnter member IDs (comma-separated, blank for all) > ",
    ...
    'ja': {
        ...
        "blog_found_posts": "{} 件のブログ記事が見つかりました。",
        "blog_no_blogs": "ダウンロードするブログがありません。",
        "blog_tqdm_scanning": "スキャン",
        ...
        "run_done": "\n完了！",
        "run_tqdm_scanning": "グループをスキャン中",
        "run_tqdm_fetching": "メンバーを取得中",
        "run_output": "出力ディレクトリ: {}",
        "run_error": "実行エラー: {}",
        "run_fatal": "\n致命的なエラー: {}",
        "run_interrupted": "\n中断されました。",
    ...
    'zh-TW': {
        ...
        "mode_selection": "\n請選擇模式：\n[1] Message 備份 (需訂閱)\n[2] 官方部落格備份 (免費)\n> ",
        "blog_fetching_members": "正在從官網讀取成員名單...",
        "blog_select_members": "\n目前可選成員：",
        "blog_id_prompt": "\n請輸入成員 ID (以逗號分隔，留空則全選) > ",
        "blog_scanning": "正在掃描部落格...",
        "blog_downloading": "正在下載部落格...",
        "blog_found_posts": "已找到 {} 篇部落格文章。",
        "blog_no_blogs": "沒有找到可下載的部落格。",
        "blog_tqdm_scanning": "掃描中",
        ...
        "run_phase_3": "\n第三階段：正在下載媒體檔案 ({} 個檔案)...",
        "run_done": "\n完成！",
        "run_tqdm_scanning": "正在掃描群組",
        "run_tqdm_fetching": "正在讀取成員",
        "run_output": "輸出目錄：{}",
        "run_error": "執行錯誤：{}",
        "run_fatal": "\n嚴重錯誤：{}",
        "run_interrupted": "\n已中斷。",
    ...
    'zh-CN': {
        ...
        "mode_selection": "\n选择模式：\n[1] Message 备份 (需订阅)\n[2] 官方博客备份 (免费)\n> ",
        "blog_fetching_members": "正在从官网获取成员列表...",
        "blog_select_members": "\n可选成员：",
        "blog_id_prompt": "\n请输入成员 ID (以逗号分隔，留空则全选) > ",
        "blog_scanning": "正在扫描博客...",
        "blog_downloading": "正在下载博客...",
        "blog_found_posts": "已找到 {} 篇博客文章。",
        "blog_no_blogs": "没有找到可下载的博客。",
        "blog_tqdm_scanning": "扫描中",
        ...
        "run_phase_3": "\n第三阶段：正在下载媒体文件 ({} 个文件)...",
        "run_done": "\n完成！",
        "run_tqdm_scanning": "正在扫描群组",
        "run_tqdm_fetching": "正在获取成员",
        "run_output": "输出目录：{}",
        "run_error": "运行错误：{}",
        "run_fatal": "\n致命错误：{}",
        "run_interrupted": "\n已中断。",
    ...
    'yue': {
        ...
        "mode_selection": "\n揀模式：\n[1] Message 備份 (要訂閱)\n[2] 官方 Blog 備份 (免費)\n> ",
        "blog_fetching_members": "喺官網攞緊成員名單...",
        "blog_select_members": "\n揀得嘅成員：",
        "blog_id_prompt": "\n請輸入成員 ID (用逗號分開，留空就全選) > ",
        "blog_scanning": "Scan 緊 Blog...",
        "blog_downloading": "下載緊 Blog...",
        "blog_found_posts": "搵到 {} 篇 Blog 文章。",
        "blog_no_blogs": "搵唔到可以下載嘅 Blog。",
        "blog_tqdm_scanning": "掃描緊",
        ...
        "run_phase_3": "\nPhase 3: 下載緊媒體檔案 ({} 個檔案)...",
        "run_done": "\n搞掂！",
        "run_tqdm_scanning": "Scan 緊群組",
        "run_tqdm_fetching": "攞緊成員",
        "run_output": "輸出目錄：{}",
        "run_error": "執行錯誤：{}",
        "run_fatal": "\n嚴重錯誤：{}",
        "run_interrupted": "\n已中斷。",
